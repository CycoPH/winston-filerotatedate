...
var FileRotateDate = exports.FileRotateDate = function (options) {
	...
	this.createLogFolder = options.createLogFolder != null ? options.createLogFolder : false;		// if true, then create logFolder if not exists (we default to false as not to break previous functionality)
